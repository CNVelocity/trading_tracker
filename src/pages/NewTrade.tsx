  ...
  return (
    <div className="max-w-xl mx-auto space-y-5">
      ...
      <div>
        ...
        <p className="text-xs text-[var(--color-text-muted)] mt-0.5">填写后将引导你完成决策评分问卷</p>
      </div>
